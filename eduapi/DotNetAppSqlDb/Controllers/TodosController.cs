...
namespace DotNetAppSqlDb.Controllers
{
    public class TodosController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            return View(new Todo { BirthDate = DateTime.Now });
        }
        ...
        public ActionResult Create([Bind(Include = "FirstName,LastName,BirthDate")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,FirstName,LastName,BirthDate")] Todo todo)
        {
